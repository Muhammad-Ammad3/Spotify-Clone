      ...
      <div className="mb-6">
        <div className="relative mb-8">
          ...
          <div className="relative -mx-4 px-4">
            <div className="absolute left-0 top-0 bottom-0 w-8 bg-linear-to-r from-black to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-8 bg-linear-to-l from-black to-transparent z-10 pointer-events-none" />
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                <div className="relative">
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center text-4xl shadow-lg group-hover:shadow-purple-500/30 transition">
                    {artist.img}
                  </div>
